      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 p-4 rounded-xl border-2 border-gray-100 hover:border-primary-300 hover:bg-primary-50 transition-all group"
          >
            ...
            <span className="font-medium text-gray-700 group-hover:text-primary-700">Entrar com Google</span>
            <LogIn className="w-4 h-4 text-gray-400 group-hover:text-primary-500" />
          </button>
